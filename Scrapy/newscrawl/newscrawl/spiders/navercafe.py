...
url_format = "https://search.naver.com/search.naver?where=article&ie=utf8&query={1}&prdtype=0&t=0&st=date&date_option=6&date_from={0}&date_to={0}&srchby=text&dup_remove=1&cafe_url=&without_cafe_url=&board=&sm=tab_pge&nso=so:dd,p:from{0}to{0},a:all&start={2}"
...
class NavercafeSpider(scrapy.Spider):
    ...
    def parse_iframe(self, response):    
        href = 'https:' + response.xpath("//iframe/@src").get()
